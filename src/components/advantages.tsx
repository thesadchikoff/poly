...
const Advantages = () => {
    return (
        <div
            ...
            <div className={'p-5'}>
                <span className="text-center text-black text-opacity-40 text-[15px] font-medium">advantages</span>
            ...
            <div className={'relative img__wrap desktop:w-max mobile:w-full desktop:h-max mobile:h-full'}>
                <Image
                    src={'https://myneuralnetworks.ru/static/generate/1689172524.5586162ThdQ1ootSWAyJLbf7HhwDBfMNLUHLqB1yIX0IsVjlAo.png'}
                    fill alt={'#'}/>
                <div className={'img__description p-5 absolute top-0 left-0 bottom-0 right-0 bg-white flex flex-col desktop:gap-16 mobile:gap-2'}>
...
Ламинат, паркет после полной просушки стяжки - примерно через 28 дней</span>
            ...
            <div className={'relative img__wrap'}>
                ...
                <div className={'img__description p-5 absolute top-0 left-0 bottom-0 right-0 bg-white flex flex-col desktop:gap-16 mobile:gap-2'}>
                    ...
                    <hr/>
                    <span className="text-black text-opacity-40 text-[15px] font-medium">🔧 Это современный и эффективный способ получить ровную поверхность для последующей укладки плитки или другого напольного покрытия. К тому же, хочу отметить, что стоимость этой услуги оказывается ниже, чем у аналогичных методов! <br/>
