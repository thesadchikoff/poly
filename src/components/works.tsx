    ...
    return (
        <div
            ...
            <div className={'flex flex-col w-full justify-center items-center'}>
                ...
                <span
                    className="mt-[40px] desktop:w-[700px] text-center text-black text-opacity-50 text-base font-normal mobile:w-full tablet:w-full">Сделаем ровную стяжку за 8 часов без трещин и неровностей,
...
работах</article>
                ...
                <div className={'flex flex-col gap-[17px]'}>
                    ...
                    <span>
                              ...
                              <br/>
                              <article
                                  className={'text-black text-opacity-60 font-semibold'}>более 250 проектов</article>
                          </span>
                </div>
                <div className={'flex flex-col gap-[17px]'}>
